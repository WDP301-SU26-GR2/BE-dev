...
describe('Contract HTTP controller boundaries', () => {
  const cases: Array<[ControllerClass, string, string, RequestMethod]> = [
    ...
    [ContractController, 'updateStatus', ':id/status', RequestMethod.PATCH],
    [ContractController, 'requestChanges', ':id/request-changes', RequestMethod.POST],
    [ContractController, 'boardApprove', ':id/board-approve', RequestMethod.POST],
    [ContractController, 'boardRequestChanges', ':id/board-request-changes', RequestMethod.POST],
    [ContractController, 'signMangaka', ':id/signatures/mangaka', RequestMethod.POST],
    [ContractController, 'signBoard', ':id/signatures/board', RequestMethod.POST],
