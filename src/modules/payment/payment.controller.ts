...
export class PaymentController {
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Chi tiết một payment record' })
  @ApiErrors(new PaymentRecordNotFoundException())
  ...
  getPaymentById(@Param('id') id: string): Promise<any> {
    return this.paymentService.getPaymentById(id)
  }

  @Patch(':id/approve')
  @ApiOperation({ summary: 'Board duyệt payment → APPROVED' })
  ...
  @ZodResponse({ status: 200, type: PaymentRecordResDto })
  approvePayment(@Param('id') id: string, @Body() body: ApprovePaymentBodyDto): Promise<any> {
    return this.paymentService.approvePayment(id, body)
  }
  ...
  @Roles(RoleName.BOARD_MEMBER, RoleName.SUPER_ADMIN)
  @ZodResponse({ status: 200, type: PaymentRecordResDto })
  payPayment(@Param('id') id: string, @Body() body: PayPaymentBodyDto): Promise<any> {
    return this.paymentService.payPayment(id, body)
  }
  ...
  @Roles(RoleName.BOARD_MEMBER, RoleName.SUPER_ADMIN)
  @ZodResponse({ status: 200, type: PaymentRecordResDto })
  cancelPayment(@Param('id') id: string, @Body() body: CancelPaymentBodyDto): Promise<any> {
    return this.paymentService.cancelPayment(id, body)
  }

  @Get('/contracts/:id/payments')
  @ApiOperation({ summary: 'Danh sách payment theo contractId' })
  @Roles(RoleName.MANGAKA, RoleName.EDITOR, RoleName.BOARD_MEMBER, RoleName.SUPER_ADMIN)
  @ZodResponse({ status: 200, type: PaymentRecordListResDto })
  getPaymentsByContract(@Param('id') contractId: string): Promise<any> {
    return this.paymentService.getPaymentsByContract(contractId)
  }

  @Get('/series/:id/payments')
  @ApiOperation({ summary: 'Danh sách payment theo seriesId' })
  @Roles(RoleName.MANGAKA, RoleName.EDITOR, RoleName.BOARD_MEMBER, RoleName.SUPER_ADMIN)
  @ZodResponse({ status: 200, type: PaymentRecordListResDto })
  getPaymentsBySeries(@Param('id') seriesId: string): Promise<any> {
    return this.paymentService.getPaymentsBySeries(seriesId)
  }

  @Get('/users/:id/payments')
  @ApiOperation({ summary: 'Danh sách payment theo receiverId' })
  @Roles(RoleName.MANGAKA, RoleName.BOARD_MEMBER, RoleName.SUPER_ADMIN)
  @ZodResponse({ status: 200, type: PaymentRecordListResDto })
  getPaymentsByUser(@Param('id') userId: string): Promise<any> {
