...
import { REPUTATION_CONFIDENCE, REPUTATION_MIN_COUNT, REPUTATION_PRIOR_MEAN } from '../reviews.constant'
...
export class ReputationService {
  ...
  compute(sum: number, count: number, recommendThreshold: number): ReputationResult {
    ...
    const isRecommended = count >= REPUTATION_MIN_COUNT && reputationScore >= recommendThreshold
