export const BoardMessages = {
  ...
  errorText: {
    ...
    'Error.EditorNotAssignedToSeries': 'Chỉ Editor phụ trách series mới được nộp báo cáo',
    'Error.ReportDecisionSeriesMismatch': 'Báo cáo phải thuộc đúng series của quyết định Hội đồng',
