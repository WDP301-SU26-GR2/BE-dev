export const TransferMessages = {
  ...
  response: {
    fullBuyoutProcessed: 'FULL_BUYOUT_TRANSFER_SUCCESSFULLY_PROCESSED',
    signatureRecorded: 'SIGNATURE_SUCCESSFULLY_RECORDED',
    chapterApproved: 'CHAPTER_APPROVED',
    chapterRejected: 'CHAPTER_REJECTED',
    chapterEscalated: 'CHAPTER_APPROVAL_ESCALATED',
    noEscalationRequired: 'NO_ESCALATION_REQUIRED_OR_RECORD_NOT_FOUND'
  }
}
