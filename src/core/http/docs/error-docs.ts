...
export const ERROR_HINTS: Record<string, string> = {
  ...
  'Error.SeriesNotSerialized': 'series must be SERIALIZED before creating chapters',
  SERIES_NOT_SERIALIZED: 'series must be SERIALIZED before an Editor can draft its contract (B-CON-01)',
