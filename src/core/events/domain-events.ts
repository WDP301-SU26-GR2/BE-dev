...
export const DomainEvent = {
  ...
  StoryboardApproved: 'storyboard.approved', // Spec 28: storyboard module → chapter (seed ProductionStage) — chapterId bắt buộc
...
export interface DomainEventPayload {
  ...
  [DomainEvent.StoryboardApproved]: { seriesId: string; storyboardId: string; chapterId: string }
}
