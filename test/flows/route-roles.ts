...
export const ROUTE_RULES: RouteRule[] = [
  ...
  { method: 'POST', path: '/survey-periods/:id/finalize', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'PATCH', path: '/survey-periods/:id/status', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/transfers/contracts/:id/signatures', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/transfers/requests', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  { method: 'GET', path: '/transfers/requests/:id', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER] },
