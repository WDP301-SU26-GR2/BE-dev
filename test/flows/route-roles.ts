...
export const ROUTE_RULES: RouteRule[] = [
  ...
  { method: 'GET', path: '/transfers/requests/assigned-editor', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  ...
  { method: 'GET', path: '/vote/periods/open', access: 'PUBLIC', allowed: [] },
