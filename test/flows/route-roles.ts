...
// Sinh lúc: 2026-07-30T04:20:55.434Z — 280 routes.
//
// access:
...
export const ROUTE_RULES: RouteRule[] = [
  ...
  { method: 'GET', path: '/annotations', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.ASSISTANT] },
  ...
  { method: 'GET', path: '/assistants', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/board/config', access: 'ROLES', allowed: [RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER, RoleCode.EDITOR] },
  { method: 'PATCH', path: '/board/config/:id', access: 'ROLES', allowed: [RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/board/decisions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/board/decisions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/board/decisions/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/board/decisions/:id/vote', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER, RoleCode.EDITOR] },
  { method: 'GET', path: '/board/decisions/:id/votes', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'GET', path: '/board/reports', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/board/reports', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'GET', path: '/board/reports/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'GET', path: '/board/sessions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/board/sessions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/board/sessions/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'PATCH', path: '/board/sessions/:id/conclude', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/board/sessions/:id/messages', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'PATCH', path: '/board/sessions/:id/phase', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  { method: 'PATCH', path: '/board/sessions/:id/start', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/chapters/:id/names', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/chapters/:id/names/:nameId', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/chapters/:id/pages', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.ASSISTANT, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'POST', path: '/chapters/:id/pages', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  { method: 'GET', path: '/chapters/:id/progress', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/chapters/:id/stages', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/chapters/:id/stages/:stageId/pages', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR] },
  ...
  { method: 'GET', path: '/collaboration-invites/:id', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.ASSISTANT] },
  ...
  { method: 'GET', path: '/contracts', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/contracts', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'GET', path: '/contracts/:contractId/amendments', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/contracts/:contractId/amendments', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'GET', path: '/contracts/:contractId/amendments/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'PATCH', path: '/contracts/:contractId/amendments/:id', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'POST', path: '/contracts/:contractId/amendments/:id/reject', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  { method: 'POST', path: '/contracts/:contractId/amendments/:id/sign/board', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/contracts/:contractId/amendments/:id/sign/mangaka', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  ...
  { method: 'GET', path: '/contracts/:contractId/payment-conditions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/contracts/:contractId/payment-conditions', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'PATCH', path: '/contracts/:contractId/payment-conditions/:conditionId', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'PATCH', path: '/contracts/:contractId/payment-conditions/:conditionId/disable', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'GET', path: '/contracts/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  ...
  { method: 'GET', path: '/contracts/:id/pdf', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/contracts/:id/request-changes', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  { method: 'POST', path: '/contracts/:id/revenue', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER, RoleCode.EDITOR] },
  ...
  { method: 'GET', path: '/contracts/:id/status', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'PATCH', path: '/contracts/:id/status', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA] },
  { method: 'GET', path: '/contracts/:id/versions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'GET', path: '/contracts/:id/versions/:versionId', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  ...
  { method: 'GET', path: '/deadline-requests', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'POST', path: '/deadline-requests', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR] },
  { method: 'GET', path: '/deadline-requests/:id', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'POST', path: '/deadline-requests/:id/agree', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR] },
  { method: 'POST', path: '/deadline-requests/:id/board-resolve', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/deadline-requests/:id/counter', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR] },
  { method: 'POST', path: '/deadline-requests/:id/finalize', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'POST', path: '/deadline-requests/:id/reject', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR] },
  { method: 'POST', path: '/deadline-requests/:id/withdraw', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR] },
  ...
  { method: 'GET', path: '/mangakas', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN, RoleCode.MANGAKA] },
  ...
  { method: 'GET', path: '/payments/:id', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN, RoleCode.MANGAKA, RoleCode.EDITOR] },
  { method: 'PATCH', path: '/payments/:id/approve', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER] },
  { method: 'PATCH', path: '/payments/:id/cancel', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'PATCH', path: '/payments/:id/pay', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/payments/contracts/:id/payments', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/payments/series/:id/payments', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/payments/users/:id/payments', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'DELETE', path: '/publication-versions/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/publication-versions/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN, RoleCode.MANGAKA] },
  { method: 'PATCH', path: '/publication-versions/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/rankings', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/rankings/aggregate', access: 'PUBLIC', allowed: [] },
  { method: 'GET', path: '/rankings/board', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/reprint-requests', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.MANGAKA, RoleCode.SUPER_ADMIN] },
  { method: 'POST', path: '/reprint-requests', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'GET', path: '/reprint-requests/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.MANGAKA, RoleCode.SUPER_ADMIN] },
  { method: 'PATCH', path: '/reprint-requests/:id/board-approve', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER] },
  { method: 'GET', path: '/reprint-requests/:id/chapters', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.MANGAKA, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/reprint-requests/:id/chapters/:chapterId', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.MANGAKA, RoleCode.SUPER_ADMIN] },
  { method: 'PATCH', path: '/reprint-requests/:id/chapters/:chapterId/approve', access: 'ROLES', allowed: [RoleCode.EDITOR] },
  { method: 'PATCH', path: '/reprint-requests/:id/chapters/:chapterId/assign-reviser', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER, RoleCode.EDITOR] },
  { method: 'PATCH', path: '/reprint-requests/:id/chapters/:chapterId/manuscript', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  { method: 'PATCH', path: '/reprint-requests/:id/mangaka-review', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  { method: 'GET', path: '/revision-requests', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.ASSISTANT, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'PATCH', path: '/revision-requests/:id/resolve', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.ASSISTANT] },
  { method: 'GET', path: '/series', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/series/:id', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/series/:id/defense-dashboard', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/series/:id/names', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/series/:id/names/:nameId', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'POST', path: '/series/:id/propose-completion', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR] },
  ...
  { method: 'GET', path: '/series/:seriesId/publication-versions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN, RoleCode.MANGAKA] },
  { method: 'POST', path: '/series/:seriesId/publication-versions', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/survey-periods', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/survey-periods', access: 'ROLES', allowed: [RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/survey-periods/:id', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'POST', path: '/survey-periods/:id/finalize', access: 'ROLES', allowed: [RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/survey-periods/:id/rankings', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'PATCH', path: '/survey-periods/:id/status', access: 'ROLES', allowed: [RoleCode.SUPER_ADMIN] },
  { method: 'GET', path: '/survey-periods/:id/survey-data', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  { method: 'GET', path: '/survey-periods/:id/votes', access: 'ROLES', allowed: [RoleCode.EDITOR, RoleCode.SUPER_ADMIN, RoleCode.BOARD_MEMBER] },
  ...
  { method: 'POST', path: '/tasks/:id/download-url', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.ASSISTANT, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  ...
  { method: 'GET', path: '/transfers/contracts/:id', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'POST', path: '/transfers/contracts/:id/sign', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.BOARD_MEMBER] },
  { method: 'GET', path: '/transfers/contracts/:id/signatures', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'POST', path: '/transfers/requests', access: 'ROLES', allowed: [RoleCode.MANGAKA] },
  { method: 'GET', path: '/transfers/requests/:id', access: 'ROLES', allowed: [RoleCode.MANGAKA, RoleCode.EDITOR, RoleCode.BOARD_MEMBER, RoleCode.SUPER_ADMIN] },
  { method: 'POST', path: '/transfers/requests/:id/assign-full-buyout', access: 'ROLES', allowed: [RoleCode.BOARD_MEMBER] },
